...
const Header = ({ header, isIconActive = true }: HeaderProps) => {
  return (
    <Grid display={'flex'} alignItems={'flex-end'}>
      ...
      <Typography letterSpacing={'0.08em'} color={'#F0F0F3'} fontFamily={'Gilroy'} fontWeight={700} textTransform={'uppercase'} lineHeight={'16px'} fontSize={'16px'}>
        { header }
      </Typography>
    </Grid>
  );
